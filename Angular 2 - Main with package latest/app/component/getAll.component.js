...
var GetAllComponent = (function () {
    function GetAllComponent(http, pagerService, _employeeService) {
        this.http = http;
    ...
    GetAllComponent.prototype.setPage = function (page, no) {
        if (page < 1 || page > this.pager.totalPages) {
            return;
        }
        // get pager object from service
        this.pager = this.pagerService.getPager(this.allItems.length, page, no);
...
GetAllComponent = __decorate([
    ...
    __metadata("design:paramtypes", [http_1.Http, pager_service_1.PagerService, employee_service_1.EmployeeService])
], GetAllComponent);
