...
import com.ustri.jpa.pagination.page;
...
public class ContactDAOImpl implements ContactDAO {
	...
	public Page<Employee> findAll(Pageable pageable) {
		EntityManagerFactory emfactory = Persistence.createEntityManagerFactory( emf );
		JpaRepositoryFactory jparf;
		jparf=new JpaRepositoryFactory(emfactory.createEntityManager());
		page crep=jparf.getRepository(page.class);
